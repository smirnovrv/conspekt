...
&НаКлиенте
Процедура ПослеВыбораКаталогаСохраненияФайла(КаталогВыбор, ЭтотОбъект) Экспорт
    ...
    ДвДанные= СсылкаНаДвоичныеДанныеФайла(Элементы.Комментарии.ТекущиеДанные.Картинка);
...
Процедура ОбработатьВыборФайла(Результат, Адрес, ВыбранноеИмяФайла, ДополнительныеПараметры) Экспорт
	...
	Структура.Вставить("Имя", ОписаниеФайла.ИмяБезРасширения);
	Структура.Вставить("Расширение", ОписаниеФайла.СсылкаНаФайл.Расширение);
	
	СохранитьФайлВХранилище(Структура);	
...
Процедура ПослеЗакрытияДиалогаВыбора (ОписаниеФайла, ДопПараметры) Экспорт
	...
	Если Элементы.Комментарии.ТекущиеДанные = Неопределено Тогда
		ИсходныйНомерСтроки = Объект.Комментарии.Количество();
	Иначе		
