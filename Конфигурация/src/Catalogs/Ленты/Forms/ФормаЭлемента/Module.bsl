 	...
 	Для Каждого СтрокаТЧ Из Объект.Комментарии Цикл
		Если ЗначениеЗаполнено(СтрокаТЧ.Тэг) Тогда
			Если СтрокаТЧ.Тэг.Одиночный Тогда
				Объект.ОсновнойТекст = Объект.ОсновнойТекст + "<" + СтрокаТЧ.Тэг.Наименование + ">" + СтрокаТЧ.Коментарий;
			Иначе
				Объект.ОсновнойТекст = Объект.ОсновнойТекст + "<" + СтрокаТЧ.Тэг.Наименование + ">" + СтрокаТЧ.Коментарий + "</" + СтрокаТЧ.Тэг.Наименование + ">";
			КонецЕсли;	
		Иначе
